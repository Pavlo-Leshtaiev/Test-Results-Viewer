package edu.trv.spring.rest;

import edu.trv.fixtures.DbHelpers;
import edu.trv.fixtures.RestHelpers;
import edu.trv.helpers.HelpersConfiguration;
...
import edu.trv.spring.rest.controllers.TestRunRestController;
...
public class TestRunRestControllerMockTest {
    ...
    public void T000_getAllTestRuns() throws Exception {
        ...
        // Method under test
        mockMvc.perform(MockMvcRequestBuilders.get(RestHelpers.TESTRUNS))
